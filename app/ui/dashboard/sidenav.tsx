...
export default function SideNav() {
  return (
    <div className="flex h-full flex-col px-3 py-4 md:px-2">
      <a href="https://imgur.com/usjEbcJ" className="mb-2 flex h-20 items-end justify-start rounded-md bg-purple-400 p-4 md:h-40">
        <img src="https://imgur.com/usjEbcJ" alt="Katty" className="w-40" />
      </a>
